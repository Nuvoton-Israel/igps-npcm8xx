...
def ReplaceComponent(TypeOfKey, pinCode,isPalladium, component_num):
	...
	try:
		...
		if (choice == 1):
			...
			Sign_binary(TipFwAndHeader_L0_bin,  112, eval(kmt_key_which_signs_tip_fw_L0),  16, TipFwAndHeader_L0_secure_bin,  TypeOfKey, pinCode, eval("id_kmt_key" + kmt_key_which_signs_tip_fw_L0[-1]) , isECC, config["lms_flags"]["is_LMS_tip_fw_L0"] ,key_paths[lms_key_which_signs_tip_fw_L0][0])
			Sign_binary(TipFwAndHeader_L1_bin,  112, eval(skmt_key_which_signs_tip_fw_L1), 16, TipFwAndHeader_L1_secure_bin,  TypeOfKey, pinCode, eval("id_skmt_key" + skmt_key_which_signs_tip_fw_L1[-1]), isECC, config["lms_flags"]["is_LMS_tip_fw_L1"] ,key_paths[lms_key_which_signs_tip_fw_L1][0])
			shutil.copy(TipFwAndHeader_L0_secure_bin,            TipFwAndHeader_L0_bin)
			shutil.copy(TipFwAndHeader_L1_secure_bin,            TipFwAndHeader_L1_bin)
			...
			Sign_binary(BootBlockAndHeader_bin, 112, eval(skmt_key_which_signs_bootblock), 16, BootBlockAndHeader_secure_bin, TypeOfKey, pinCode, eval("id_skmt_key" + skmt_key_which_signs_bootblock[-1]), isECC, config["lms_flags"]["is_LMS_bootblock"] ,key_paths[lms_key_which_signs_bootblock][0])
			shutil.copy(BootBlockAndHeader_secure_bin,            BootBlockAndHeader_bin)
			...
			Sign_binary(UbootAndHeader_bin,     112, eval(skmt_key_which_signs_uboot),     16, UbootAndHeader_secure_bin,     TypeOfKey, pinCode, eval("id_skmt_key" + skmt_key_which_signs_uboot[-1]), isECC, config["lms_flags"]["is_LMS_uboot"] ,key_paths[lms_key_which_signs_uboot][0])
			shutil.copy(UbootAndHeader_secure_bin,            UbootAndHeader_bin)
			...
			Sign_binary(BL31_AndHeader_bin,     112, eval(skmt_key_which_signs_BL31),      16, BL31_AndHeader_secure_bin,     TypeOfKey, pinCode, eval("id_skmt_key" + skmt_key_which_signs_BL31[-1]), isECC, config["lms_flags"]["is_LMS_BL31"] ,key_paths[lms_key_which_signs_BL31][0])
			shutil.copy(BL31_AndHeader_secure_bin,            BL31_AndHeader_bin)
			...
			Sign_binary(OpTeeAndHeader_bin,     112, eval(skmt_key_which_signs_OpTee),     16, OpTeeAndHeader_secure_bin,     TypeOfKey, pinCode, eval("id_skmt_key" + skmt_key_which_signs_OpTee[-1]), isECC, config["lms_flags"]["is_LMS_OpTee"] ,key_paths[lms_key_which_signs_OpTee][0])
			shutil.copy(OpTeeAndHeader_secure_bin,            OpTeeAndHeader_bin)
			...
			Sign_binary(SkmtAndHeader_bin,      112, eval(kmt_key_which_signs_skmt),       16, SkmtAndHeader_secure_bin,      TypeOfKey, pinCode, eval("id_kmt_key" + kmt_key_which_signs_skmt[-1]), isECC, config["lms_flags"]["is_LMS_skmt"] ,key_paths[lms_key_which_signs_skmt][0])
			shutil.copy(SkmtAndHeader_secure_bin,            SkmtAndHeader_bin)
